{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-0616c350-fddc-409a-a15e-43b8d2c5f879" = [ ];
    ...
    configFile = {
      ...
      "kactivitymanagerdrc"."activities"."0616c350-fddc-409a-a15e-43b8d2c5f879" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "0616c350-fddc-409a-a15e-43b8d2c5f879";
      "kcminputrc"."Libinput.10182.480.GXTP7863:00 27C6:01E0 Touchpad"."DisableWhileTyping" = false;
      "kcminputrc"."Libinput.10182.480.GXTP7863:00 27C6:01E0 Touchpad"."NaturalScroll" = true;
      "kcminputrc"."Libinput.10182.480.GXTP7863:00 27C6:01E0 Touchpad"."TapToClick" = true;
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{9784a243-c6a4-4d6c-87fc-280005e41bc5}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{00482f47-fd2a-4954-b47b-33cafbbe82af}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{fbafe5b3-66c8-4173-bf15-1fcfd0dc175a}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{ddc419de-e17f-49cd-9715-473240a0820f}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{3335e45e-e9c9-4148-a17b-5921b010d659}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{16742f6b-dbd7-4dc0-ba9a-7159858d2110}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{3aa1e9fe-e369-4f41-9e53-4d025482b6bf}";
      ...
      "kwinrc"."Desktops"."Id_1" = "f5283c10-ae3b-46f8-b9dc-fcaefff6c840";
